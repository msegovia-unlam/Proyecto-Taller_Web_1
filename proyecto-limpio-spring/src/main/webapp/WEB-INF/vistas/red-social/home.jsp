    ...
    <c:forEach items="${publicaciones}" var="publicacion">
        <article class="flex" >
            <div class="d-flex border mb-2">
                <div class="mt-2">
                    <c:if test="${publicacion.usuario.imagen.id == null}">
                    ...
                    <c:if test="${publicacion.usuario.imagen.id != null}">
                        <div>
                            <img class="rounded-circle" style="width:54px; margin: 5px;"
                                 src="${pageContext.request.contextPath}/img/${publicacion.usuario.imagen.id}.jpg" alt="foto-perfil">
                        </div>
                    </c:if>
<%--                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-circle" width="54"--%>
<%--                         height="54" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000" fill="none" stroke-linecap="round"--%>
